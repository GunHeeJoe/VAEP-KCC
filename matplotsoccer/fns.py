...
# print(font)
# # 한글 폰트 설정
# font_path = font_location  # 나눔고딕 폰트 파일의 경로를 지정합니다.
...
def actions(
    ...
    if labeltitle is not None:
        # labeltitle_list = []
        # for key in labeltitle:
        #     labeltitle_list.append(korea_label[key])
        ...
        #plt.plot(np.NaN, np.NaN, "-", color="none", label=["Time", "플레이 유형","선수이름",
        #                                                   "득점 확률","실점 확률", "VAEP"])
